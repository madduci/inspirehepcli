...
func parseArxivPublication(publication *Publication, outputType OutputType) string {
	// Append author names
	authorsList := ""
...
func ConvertArxivJsonToMarkdown(jsonData string) string {
	publication := getPublicationFromJson(jsonData)
	return parseArxivPublication(publication, markdownType)
}

func ConvertArxivJsonToHtml(jsonData string) string {
	publication := getPublicationFromJson(jsonData)
	return parseArxivPublication(publication, htmlType)
}